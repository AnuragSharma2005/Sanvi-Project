  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-[#0b1430] via-[#3b0764] to-black text-white px-6 sm:px-12 flex flex-col sm:flex-row items-center justify-center gap-12 pt-20 sm:pt-0 pb-20">
      ...
      <motion.div
        ...
        animate="visible"
      >
        <h1 className="text-4xl sm:text-4xl font-extrabold text-center bg-gradient-to-r from-pink-400 via-purple-400 to-blue-400 bg-clip-text text-transparent font-[Playfair_Display]"
        >Future Outlook for Amazon in India</h1>
