...
export default function Navbar() {
  ...
  return (
    ...
    >
      ...
      <h1
        className="text-2xl sm:text-2xl md:text-4xl font-extrabold text-center bg-gradient-to-r from-pink-400 via-purple-400 to-blue-400 bg-clip-text text-transparent font-[Playfair_Display] cursor-pointer whitespace-nowrap md:whitespace-normal"
